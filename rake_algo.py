...
if test:
    text = "Construction Work for Restaurants. Similar Facilities. Works In Design. Construction for Upgrading of The Kitchen ENSA  ."

# Split text into sentences
sentenceList = split_sentences(text.lower())
