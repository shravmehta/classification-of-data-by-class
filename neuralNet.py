...
class NeuralNetwork:
    ...
    def __init__(self, neurons, weights=None, biases=None, is_random = 1):
    ...
    def __initWeights(self, is_random):
        i = 0
        self.weights = []
    ...
    def __initBiases(self):
        ...
        #self.biases = [0 for j in range(0, numBiased)]
    ...
    def simulate(self, inputSet, outputSet, maxError, maxIterations = 100000):
